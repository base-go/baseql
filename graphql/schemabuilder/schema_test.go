...
import (
	...
	"github.com/base-go/baseql/graphql/schemabuilder/testdata"
...
func TestDuplicateEnumNamesFailSchema(t *testing.T) {
	...
	require.Contains(t, errStr, "github.com/base-go/baseql/graphql/schemabuilder_test")
	require.Contains(t, errStr, "github.com/base-go/baseql/graphql/schemabuilder/testdata")
}
...
func TestDuplicateStructTypeNamesFailSchema(t *testing.T) {
...

	{
		...
		assert.Contains(t, errStr, "github.com/base-go/baseql/graphql/schemabuilder_test")
		assert.Contains(t, errStr, "github.com/base-go/baseql/graphql/schemabuilder/testdata")
	}
