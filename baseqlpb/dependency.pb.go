...
/*
	Package baseqlpb is a generated protocol buffer package.
...
type Field struct {
	Kind FieldKind `protobuf:"varint,1,opt,name=kind,proto3,enum=baseqlpb.FieldKind" json:"kind,omitempty"`
...
func init() {
	proto.RegisterType((*Field)(nil), "baseqlpb.Field")
	proto.RegisterType((*SQLFilter)(nil), "baseqlpb.SQLFilter")
	proto.RegisterType((*ExpirationTime)(nil), "baseqlpb.ExpirationTime")
	proto.RegisterEnum("baseqlpb.FieldKind", FieldKind_name, FieldKind_value)
}
